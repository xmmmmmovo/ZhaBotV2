...
create_question = on_command(
    "创建问题", rule=not_to_me, permission=SUPERUSER | GROUP_OWNER | GROUP_ADMIN | admin, priority=89)
update_question = on_command(
    "更新问题", rule=not_to_me, permission=SUPERUSER | GROUP_OWNER | GROUP_ADMIN | admin, priority=89)
list_question = on_command("列出问题", rule=not_to_me,
                           permission=simple, priority=89)
delete_question = on_command(
    "删除问题", rule=not_to_me, permission=SUPERUSER | GROUP_OWNER | GROUP_ADMIN | admin, priority=89)
